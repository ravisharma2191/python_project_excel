...
sheet1['ADVANCE'] = 0
sheet1['HOSPITALID'] = hospital_id1
...
sheet1['TARIFFGROUPID'] = ''
sheet1['TARFFIC_CLASS_TYPE'] = np.select(
    [ Room_Type == 'OP',],
    [ 'HOSPITAL'],default='TARIFF_GROUP')
...
Room_Type =='ICU',
    ...
    [ str(hospital_id1),'1742381','1742374','1742375','1742377','1742378','1742379','1742380'],default='')
