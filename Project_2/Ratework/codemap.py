...
file_path = r"C:\Users\software.support\Desktop\New folder\Output-Package_new.xlsx"
...
sheet1 = pd.read_excel(file_path1, sheet_name='BulkPKGSheet')

# Room type columns
room_columns = ['OP','Day Care', 'Eco Celing', 'Twin Ceiling', 'Single Celing']
